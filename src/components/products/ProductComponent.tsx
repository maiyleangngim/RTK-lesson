...
export default function ProductComponent({ uuid, name, description, thumbnail, priceOut }: ProductType) {
  return (
    <div className="flex items-center justify-center pt-16">
      <div className="w-80 border border-blue-200 rounded-lg shadow-md p-4">
        ...
        <div className="mt-4">
          ...
          <p className="uppercase text-gray-900 text-lg font-medium">{name}</p>
          {/* Ratings */}
          ...
          <div className="flex items-end justify-between">
            <div className="flex items-baseline space-x-2 mt-2">
              <span className="text-blue-600 text-xl font-semibold">{priceOut}</span>
            </div>
