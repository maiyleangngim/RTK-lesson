...
import { useGetSingleProductQuery } from '@/services/ecommerceApi'
...
export default function ProductDetailComponent({ uuid }: productUUID) {
//   const { data } = useGetSingleProductQuery(uuid);
//     console.log("Thumbnail:", data?.thumbnail);

// console.log("data =", data);
// console.log("thumbnail =", data?.thumbnail);

const { data, isLoading } = useGetSingleProductQuery(uuid);
...
console.log("Data:", data);
  ...
  return (
    <div className="flex-col md:flex-row justify-center flex gap-4 items-start py-32">
      <div className="flex bg-white rounded-lg shadow dark:bg-gray-800 flex-col md:flex-row p-16 gap-12">
        <div className="relative w-full md:w-80 flex justify-center items-center">
          <Image
            width={800}
            height={700}
            loading='eager'
